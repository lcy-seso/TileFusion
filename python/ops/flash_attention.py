...
class FlashAttention:
    ...
    def __init__(
        ...
        Args:
            tile_length_q: Tile size for query sequence length dimension.
            tile_length_kv: Tile size for key/value sequence length dimension.
    ...
    def __call__(
        ...
        self.m, self.k = query.size(1), query.size(2)
        self.n, self.p = value.size(1), value.size(2)
